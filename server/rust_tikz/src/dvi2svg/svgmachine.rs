...
impl Machine for SVGMachine {
    fn get_content(&self) -> String {
        ...
        // We directly inject all font styles. Therefore, the following style block was removed.
        //
        //<style>
    ...
    fn put_text(&mut self, buffer: Vec<u32>, font_helper: &FontDataHelper) -> f64 {
        ...
        for &c in buffer.iter() {
            ...
            if let Some(metrics) = metrics_option {
                ...
                // Use the new fontmap module to get the correct Unicode character
                let unicode_str = fontmap::get_unicode(font_name, c);
                html_text.push_str(&unicode_str);
            }
            */
        }
