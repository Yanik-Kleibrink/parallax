> [!NOTE]
> This is a slightly modified version of the [rust_tikz](https://crates.io/crates/rust_tikz) crate that fixes a bug concerning the EOF in the virtual file system that prevents the rendering of tikz pictures with math fonts.
